...
int main() {
  ...
  // test Nameless 1
  {
    ...
    std::cout << "Nameless expression is \"" << Nameless::to_str(nLet2) << "\"" << std::endl;
  ...
  // test Instruction 1
  {
    ...
    Nameless::Expr* nLet2 = Compiler::lowerFromExprToNameless(let2, {});
    Instruction::InstrPtrs instrPtrs = Compiler::lowerFromNamelessToInstruction(nLet2, {});
    std::cout << "Instructions are\n" << Instruction::to_str(instrPtrs);
    std::cout << "eval should be: " << Instruction::eval(instrPtrs, {}) << std::endl;
  }
  ...
  // test Instruction 3 
  {
    ...
    Instruction::InstrPtrs instrPtrs = Compiler::lowerFromNamelessToInstruction(nAdd2, {});
    std::cout << "Instructions are\n" << Instruction::to_str(instrPtrs);
    std::cout << "eval should be: " << Instruction::eval(instrPtrs, {}) << std::endl;
  }
